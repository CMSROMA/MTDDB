...
SELECT P.BARCODE, PC.BARCODE AS CHILD, C.DISPLAY_NAME AS ATTRIBUTE_NAME, P.NAME AS ATTRIBUTE_VALUE 
       ...
       JOIN CMS_MTD_CORE_CONSTRUCT.PART_ATTR_LISTS A ON A.PART_ID = PC.PART_ID
       JOIN CMS_MTD_CORE_ATTRIBUTE.POSITION_SCHEMAS P ON P.ATTRIBUTE_ID = A.ATTRIBUTE_ID
       JOIN CMS_MTD_CORE_ATTRIBUTE.ATTR_BASES B ON B.ATTRIBUTE_ID = A.ATTRIBUTE_ID
       JOIN CMS_MTD_CORE_ATTRIBUTE.ATTR_CATALOGS C ON C.ATTR_CATALOG_ID = B.ATTR_CATALOG_ID;
